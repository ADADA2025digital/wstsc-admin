...
const EnrolStudents = () => {
  ...
  const filterStudentsForParent = (studentsData) => {
    ...
    return studentsData.filter(student => {
      ...
      return student.parent_carers?.some(parent => 
  ...
  const fetchStudents = async (isRefresh = false) => {
    ...
    try {
      ...
      const formattedStudents = filteredStudents.map((student, index) => {
        const firstParent = student.parent_carers && student.parent_carers.length > 0 
        ...
        columns: [
          ...
          },
          {
            ...
            render: function (data, type, row) {
              return `
                 <i class="bi bi-eye view-icon" data-student-id="${row.id}" style="cursor: pointer;"></i>
              `;
            },
          },
        ],
      ...
      <div className="container-fluid px-4 py-3">
        ...
        <Card className="mt-4">
          <Card.Body className="text-center py-5">
            ...
            {userRole === 'parent' && (
              <button className="btn btn-outline-primary" onClick={() => navigate('/enrol')}>
                Student Enrollment
              </button>
            )}
          </Card.Body>
